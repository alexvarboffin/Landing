...
import com.j0bar.client.databinding.SplashLottieZeroBinding;
...
public class LottieSplash extends AppCompatActivity {
    ...
    SplashLottieZeroBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = SplashLottieZeroBinding.inflate(getLayoutInflater());
        ...
        textName.setText(""); // or ""R.string.app_name
...
//            finish();
    ...
    private void createTimer() {
        ...
        countDownTimer = new CountDownTimer(Cfg9.cfg.getCounterTimeMs(), 1000) {
            @Override
