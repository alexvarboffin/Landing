...
import online.biletiz.rabota.databinding.ActivitySplashLottieBinding
...
class LottieSplash : AppCompatActivity() {
    ...
    var binding: ActivitySplashLottieBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding!!.textVer.setPaintFlags(binding!!.textVer.getPaintFlags() or Paint.UNDERLINE_TEXT_FLAG)
...
//        startAnimation(animationSet);
        ...
        //@@@ else
        //@@@     task.execute();
        val dim = getResources().getDimension(R.dimen.tvProgress_translation_distance)
        val startY = binding!!.textVer.getY() + dim
...
//            finish();
    ...
    private fun startAnimation(animationSet: AnimationSet?) {
        ...
        Handler().postDelayed(Runnable { startAnimation(animationSet) }, 10)
    }
    ...
    private fun startMainActivity() {
        try {
            val intent: Intent? =
                Intent(this.getApplicationContext(), MainActivity::class.java).setFlags(
                    COOL_FLAGH
                )
...
//        animator.start();
    ...
    companion object {
        ...
        val screenWidth: Int
            get() = Resources.getSystem().getDisplayMetrics().widthPixels
    }
}