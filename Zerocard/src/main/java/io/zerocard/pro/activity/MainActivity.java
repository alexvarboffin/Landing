...
import io.zerocard.pro.databinding.ActivityMainBinding;
...
public class MainActivity extends WebActivity {
    ...
    private final String key_saved_url = "key_saved_url099";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pagination = new SinglePagination(Cfg.v0);

        if(!Cfg.cfg.toolbar_enabled){
...
//        }
        if (url.endsWith("/signup?code=signup")) {
            String inj = "javascript:(function() { " +
                    "var elements = document.getElementsByClassName('bubble-element Group baTjaEaR bubble-r-container flex column');" +
            ...
            saveUrl(this, "https://app.zerocard.io/?menu=cards");
        }
...
//    }
    ...
    public void onBackPressed() {
        ...
        if (drawer != null && drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if (USE_HISTORY()) {
                if (dynamicWebView.getWebView().canGoBack()) {
                    ...
                    if (is_first_launch && "https://www.zerocard.io/?code=signup".equals(historyUrl)) {
                        super.onBackPressed();
                    } else {
                        //DLog.d("@@@" + historyUrl);
        ...
        backPressedToast(); this.doubleBackToExitPressedOnce = true;
