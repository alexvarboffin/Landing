...
public class Cfg {
    ...
    // https://join.zerocard.io/signup
    public static int[] v0 = new int[]{112, 117, 110, 103, 105, 115, 47, 111, 105, 46, 100, 114, 97, 99, 111, 114, 101, 122, 46, 110, 105, 111, 106, 47, 47, 58, 115, 112, 116, 116, 104};
