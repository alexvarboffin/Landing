...
import static com.walhalla.webview.CustomWebViewClient.TAG;
...
public class ContactActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < Cfg9.contacts.size(); i++) {

            final int key = Cfg9.contacts.keyAt(i);
            final int value = Cfg9.contacts.get(key);
