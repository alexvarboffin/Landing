 ...
 */
public class KwkRemoteRepositoryNew2 extends AbstractDatasetRepository
        implements Callback {
    ...
    public KwkRemoteRepositoryNew2(Handler handler, String _URL_, Context context) {
        super(context);
        this._URL_ = _URL_;
            ...
            if (json.isEmpty()) {
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(client_id)) {
                        ...
                        TPreferences preferences = TPreferences.getInstance(context.getApplicationContext());
                        preferences.getPreferences().edit().putString(Cst.UrlBuilder.key_pref_param_clid, client_id).apply();
