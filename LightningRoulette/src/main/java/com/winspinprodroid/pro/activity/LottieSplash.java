...
import com.winspinprodroid.pro.databinding.ActivitySplashLottieBinding;
...
//        startAnimation(animationSet);
    ...
    private void tvProgressAnimation(float startY, float dim, TextView tvProgress, String text0, boolean b) {
        ...
        fadeIn.setInterpolator(new AccelerateInterpolator());
        //fadeIn.setInterpolator(new AccelerateDecelerateInterpolator());
        fadeIn.setDuration(1400); // Длительность анимации в миллисекундах

        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.playTogether(fadeIn, translationY, /*scaleX,*/ scaleY);
        animatorSet.setInterpolator(new AccelerateDecelerateInterpolator());
        animatorSet.setDuration(1400); // Длительность анимации в миллисекундах
        animatorSet.addListener(new Animator.AnimatorListener() {
            @Override
            public void onAnimationStart(@NonNull Animator animator) {
            }
