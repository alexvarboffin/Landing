function CPlatform(iXPos, iYPos, iID, iType, oParentContainer) {
    ...
    this._init = function (iXPos, iYPos, iID, iType, oParentContainer) {
        ...
        var oSprite = s_oSpriteLibrary.getSprite("floor_" + iType);
        ...
        _oRectangle = new createjs.Rectangle(_oRectangleMeasure.x, _oRectangleMeasure.y, _oRectangleMeasure.w, _oRectangleMeasure.h);
