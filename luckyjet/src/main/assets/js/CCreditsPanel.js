function CCreditsPanel() {
    ...
    this._init = function () {
        ...
        _oLinkOutline = new createjs.Text("www.codethislab.com", "24px " + FONT_GAME, "#000");
        ...
        _oLink = new createjs.Text("www.codethislab.com", "24px " + FONT_GAME, TEXT_COLOR);
