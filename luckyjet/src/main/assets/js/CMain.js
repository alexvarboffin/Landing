function CMain(oData) {
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'coin',loop:false,volume:1, ingamename: 'coin'});
        s_aSoundsInfo.push({path: './sounds/',filename:'click',loop:false,volume:1, ingamename: 'click'});
        s_aSoundsInfo.push({path: './sounds/',filename:'step',loop:true,volume:1, ingamename: 'step'});
        s_aSoundsInfo.push({path: './sounds/',filename:'jet',loop:false,volume:1, ingamename: 'jet'});
        s_aSoundsInfo.push({path: './sounds/',filename:'die',loop:false,volume:1, ingamename: 'die'});
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("floor_0", "./sprites/floor_0.png");
        s_oSpriteLibrary.addSprite("coin", "./sprites/coin.png");
        s_oSpriteLibrary.addSprite("but_fullscreen", "./sprites/but_fullscreen.png");

        for (var i = 0; i < BG_TYPES; i++) {
            s_oSpriteLibrary.addSprite("bg_" + i, "./sprites/bg/bg_" + i + ".jpg");
        }

        for (var i = 0; i < GID_OBJECTS.length; i++) {
