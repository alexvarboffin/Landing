package com.ivanbet.sport.app.activity;
...
import com.ivanbet.sport.app.fragment.ClubDescriptionFragment;
import com.ivanbet.sport.app.fragment.ClubsListFragment;
import com.ivanbet.sport.app.fragment.SeasonDescriptionFragment;
import com.ivanbet.sport.app.fragment.SimpleClubViewModel;
import com.ivanbet.sport.app.fragment.base.CoreFragment;
import com.ivanbet.sport.app.fragment.SeasonsListFragment;
...
import com.walhall.sourcefb.repository.impl.FirebaseRepository;
...
public class MainActivity extends CompatActivity implements CoreFragment.Callback {
...
//        if (aa != null) {
//            aa.setSubtitle(
//                    "Sim-card: " + Utils.isSimSupport(this)
//                            + ", VPN: " + Utils.useVpn(this));
//        }
    }
...
//        }
        ...
        Button seasons = findViewById(R.id.seasons);
...
//                return true;
        if (itemId == R.id.action_refresh) {
            ...
            Launcher.openBrowser(this, getString(R.string.ppa));
            return true;
...
//                return true;
    ...
    @Override
    protected Gfg GCfc() {
        return new Gfg.Builder().build()
//                true,
//                false,
//                UrlSaver.FIRST, true, true)
                ;
    }
    ...
    public void onClick(ViewModel navItem) {
        ...
        if (navItem instanceof HeaderObject) {
            ...
            DLog.d("[URL]" + aa.url);
            Launcher.openBrowser(this, aa.url);
        } else {
            DLog.d("@@@@" + navItem.getClass().getSimpleName());
        }
    }
