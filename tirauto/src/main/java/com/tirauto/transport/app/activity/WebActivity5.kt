...
import com.tirauto.transport.app.custom.WPresenterAAImpl2

abstract class WebActivity5 : AppCompatActivity(), ChromeView, UWVlayoutCallback,
    ConfirmationDialogFragment.Listener {
    //private CustomTabsIntent customTabsIntent;
    var presenter0: WPresenterAAImpl2? = null
        protected set
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.presenter0 =
            WPresenterAAImpl2(handler, this)
