...
import com.tirauto.transport.app.databinding.BottomBinding


class MainActivity0 : WebActivity5(), ActivityConfig {
    ...
    private val urls = arrayOf(
        "https://tirauto.com/",
        "https://tirauto.com/#calc",
        "https://tirauto.com/#vin",
        "https://tirauto.com/ostavit-zayavku/",
        "tel:+37377868686"
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = BottomBinding.inflate(layoutInflater);
...
//---            selectedListener!!.onlyRefresh(item.itemId)
        ...
        binding.bottomNavigationView.setOnItemSelectedListener { item: MenuItem ->
            when (item.itemId) {
                R.id.inicioItem -> binding.webView.loadUrl(urls[0])
                R.id.buscarItem -> binding.webView.loadUrl(urls[1])
                R.id.camaraItem -> binding.webView.loadUrl(urls[2])
                R.id.favoritosItem -> binding.webView.loadUrl(urls[3])
                R.id.perfilItem -> {

                    val intent = Intent(Intent.ACTION_DIAL).apply {
                        data = Uri.parse(urls[4])
                    }
...
//        val badge = binding.bottomNavigationView.getOrCreateBadge(R.id.inicioItem)
//        badge.number = 7
