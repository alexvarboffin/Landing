package com.chezap.client.activity;
...
import com.chezap.client.ChezapCfg;
import com.chezap.client.R;

import com.chezap.client.databinding.ActivitySplashLottieZeroBinding;
...
public class SplashChezap extends AppCompatActivity {
    ...
    ActivitySplashLottieZeroBinding binding;
...
//            // Фрагмент был открыт через глубокую ссылку
//            // Выполните необходимые действия здесь
//        } else {
//            // Фрагмент был открыт другим способом
//            // Выполните необходимые действия здесь
//        }
//        Intent intent = getIntent();
//        DLog.d("@@@@@@@@@"+intent);
//        // Проверяем, была ли активность открыта через глубокую ссылку
//        if (Intent.ACTION_VIEW.equals(intent.getAction())) {
//
//        } else {
//            // Активность была открыта напрямую (например, из лаунчера)
//            // Обработка открытия напрямую здесь
//        }


        //binding = SplashMicrocheckerBinding.inflate(getLayoutInflater());
        binding = ActivitySplashLottieZeroBinding.inflate(getLayoutInflater());
...
//        }
        ...
        if (ChezapCfg.cfg.isSplashScreenEnabled()) {
            if (ChezapCfg.cfg.isCheckConnection()) {
...
//    }
    ...
    private void createTimer() {
        ...
        countDownTimer = new CountDownTimer(ChezapCfg.cfg.getCounterTimeMs(), 1000) {
                    @Override
