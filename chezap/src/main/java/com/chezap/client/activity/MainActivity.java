...
import com.chezap.client.BuildConfig;
import com.chezap.client.ChezapCfg;
import com.chezap.client.MyOnNavigationItemSelectedListener;
import com.chezap.client.R;
import com.chezap.client.databinding.MainBinding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ActivityConfig activityConfig = new ActivityConfig() {
            ...
            public boolean isProgressEnabled() {
                return ChezapCfg.cfg.isProgressEnabled();
            }

            @Override
            public boolean isSwipeEnabled() {
                return ChezapCfg.cfg.isSwipeEnabled();
            }
        };
...
//        }
        ...
        if (ChezapCfg.cfg.isToolbarEnabled()) {
...
//                        + " - " + mThread.getName(), Toast.LENGTH_SHORT).show();
    ...
    public void onPageStarted(String url) {
        ...
        if (ChezapCfg.cfg.isProgressEnabled()) {
