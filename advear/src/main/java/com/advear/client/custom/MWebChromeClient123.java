...
public class MWebChromeClient123 extends MyWebChromeClient {
    ...
    public MWebChromeClient123(RelativeLayout child, RelativeLayout browserLayout, Activity activity, Callback callback) {
        super(callback);
    ...
    public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
        ...
        @NonNull UWView mView = new UWView(myActivity);
...
//                new MyJavascriptInterface(CompatActivity.this, __mView), "JSInterface");
        ...
        mView.setWebChromeClient(new MWebChromeClient123(
                childLayout
                , browserLayout
                , myActivity,
                new Callback() {
