...
import com.chatgpt.app.databinding.ActivitySplashLottieBinding;
...
//        }
        ...
        if (Cfg9.cfgBetApp.isSplashScreenEnabled()) {
            if (Cfg9.cfgBetApp.isCheckConnection()) {
...
//            finish();
    ...
    private void createTimer() {
        ...
        long COUNTER_TIME_MS = 2400; //2.2s

        //final TextView counterTextView = findViewById(R.id.timer);

        countDownTimer =
                new CountDownTimer(COUNTER_TIME_MS, 1000) {
                    @Override
